...
namespace PriView
{
    ...
    sealed partial class App : Application
    {
      ...
      //Window.Current.VisibilityChanged += Window_VisibilityChanged;
        ...
        Data.PickPass p1 = new Data.PickPass(ref r_pass);
         if (r_pass == null) { rootFrame.Navigate(typeof(SplitPage), e.Arguments); }
         else { rootFrame.Navigate(typeof(InputPassPage), e.Arguments); }
      }
    ...
    protected override void OnActivated(IActivatedEventArgs e)
    {
      ...
      string r_pass = null;
      Data.PickPass p1 = new Data.PickPass(ref r_pass);
      if (r_pass == null) { rootFrame.Navigate(typeof(Browser.MainBrowser)); }
      else { rootFrame.Navigate(typeof(InputPassPage)); }
    }
    ...
    private void Application_Resuming(object sender, object e)
    {
      ...
      string r_pass = null;
      Data.PickPass p1 = new Data.PickPass(ref r_pass);
      if (r_pass == null) { rootFrame.Navigate(typeof(SplitPage)); }
      else { rootFrame.Navigate(typeof(InputPassPage)); }
    }
